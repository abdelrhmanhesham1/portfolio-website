  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        <Reveal delay={0.16}>
          <p className="mt-4 font-display text-xl font-semibold text-muted sm:text-2xl">
        ...
        <Reveal delay={0.4}>
          <dl className="mx-auto mt-16 flex max-w-4xl flex-wrap items-start justify-center gap-x-10 gap-y-6">
